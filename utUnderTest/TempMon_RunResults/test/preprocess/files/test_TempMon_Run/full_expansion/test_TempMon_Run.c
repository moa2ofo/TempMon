...
void IsUnderEnter_b_CMockExpectAnyArgsAndReturn(UNITY_UINT cmock_line,
                                                _Bool cmock_to_return);
...
void IsUnderExit_b_CMockExpectAnyArgsAndReturn(UNITY_UINT cmock_line,
                                               _Bool cmock_to_return);
...
void IsOverEnter_b_CMockExpectAnyArgsAndReturn(UNITY_UINT cmock_line,
                                               _Bool cmock_to_return);
...
void IsOverExit_b_CMockExpectAnyArgsAndReturn(UNITY_UINT cmock_line,
                                              _Bool cmock_to_return);
...
# 6 "utExecutionAndResults/utUnderTest/test/test_TempMon_Run.c"
