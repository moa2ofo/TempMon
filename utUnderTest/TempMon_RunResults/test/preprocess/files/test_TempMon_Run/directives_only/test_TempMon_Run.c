...
extern void _longjmp(struct __jmp_buf_tag __env[1], int __val) __THROWNL
    __attribute__((__noreturn__));
...
extern void siglongjmp(sigjmp_buf __env, int __val) __THROWNL
    __attribute__((__noreturn__));
...
extern char *tempnam(const char *__dir, const char *__pfx) __THROW
    __attribute_malloc__ __wur __attr_dealloc_free;
...
extern FILE *fdopen(int __fd, const char *__modes) __THROW __attribute_malloc__
    __attr_dealloc_fclose __wur;
...
extern int __REDIRECT(vfscanf,
                      (FILE *__restrict __s, const char *__restrict __format,
                       __gnuc_va_list __arg),
                      __isoc99_vfscanf)
    __attribute__((__format__(__scanf__, 2, 0))) __wur;
...
extern __ssize_t __getdelim(char **__restrict __lineptr, size_t *__restrict __n,
                            int __delimiter, FILE *__restrict __stream) __wur;
...
extern FILE *popen(const char *__command,
                   const char *__modes) __attribute_malloc__
    __attr_dealloc(pclose, 1) __wur;
...
#define IsUnderEnter_b_ExpectAnyArgs()                                         \
  TEST_FAIL_MESSAGE("IsUnderEnter_b requires _ExpectAnyArgsAndReturn");
#define IsUnderEnter_b_ExpectAnyArgsAndReturn(cmock_retval)                    \
  IsUnderEnter_b_CMockExpectAnyArgsAndReturn(__LINE__, cmock_retval)
void IsUnderEnter_b_CMockExpectAnyArgsAndReturn(UNITY_LINE_TYPE cmock_line,
                                                _Bool cmock_to_return);
...
#define IsUnderEnter_b_IgnoreArg_temp_mC()                                     \
  IsUnderEnter_b_CMockIgnoreArg_temp_mC(__LINE__)
...
#define IsUnderExit_b_ExpectAnyArgs()                                          \
  TEST_FAIL_MESSAGE("IsUnderExit_b requires _ExpectAnyArgsAndReturn");
#define IsUnderExit_b_ExpectAnyArgsAndReturn(cmock_retval)                     \
  IsUnderExit_b_CMockExpectAnyArgsAndReturn(__LINE__, cmock_retval)
void IsUnderExit_b_CMockExpectAnyArgsAndReturn(UNITY_LINE_TYPE cmock_line,
                                               _Bool cmock_to_return);
...
#define IsUnderExit_b_IgnoreArg_temp_mC()                                      \
  IsUnderExit_b_CMockIgnoreArg_temp_mC(__LINE__)
...
#define IsOverEnter_b_ExpectAnyArgs()                                          \
  TEST_FAIL_MESSAGE("IsOverEnter_b requires _ExpectAnyArgsAndReturn");
#define IsOverEnter_b_ExpectAnyArgsAndReturn(cmock_retval)                     \
  IsOverEnter_b_CMockExpectAnyArgsAndReturn(__LINE__, cmock_retval)
void IsOverEnter_b_CMockExpectAnyArgsAndReturn(UNITY_LINE_TYPE cmock_line,
                                               _Bool cmock_to_return);
...
#define IsOverEnter_b_IgnoreArg_temp_mC()                                      \
  IsOverEnter_b_CMockIgnoreArg_temp_mC(__LINE__)
...
#define IsOverExit_b_ExpectAnyArgs()                                           \
  TEST_FAIL_MESSAGE("IsOverExit_b requires _ExpectAnyArgsAndReturn");
#define IsOverExit_b_ExpectAnyArgsAndReturn(cmock_retval)                      \
  IsOverExit_b_CMockExpectAnyArgsAndReturn(__LINE__, cmock_retval)
void IsOverExit_b_CMockExpectAnyArgsAndReturn(UNITY_LINE_TYPE cmock_line,
                                              _Bool cmock_to_return);
...
#define IsOverExit_b_IgnoreArg_temp_mC()                                       \
  IsOverExit_b_CMockIgnoreArg_temp_mC(__LINE__)
...
extern void *memccpy(void *__restrict __dest, const void *__restrict __src,
                     int __c, size_t __n) __THROW __nonnull((1, 2))
    __attr_access((__write_only__, 1, 4));
...
extern int memcmp(const void *__s1, const void *__s2,
                  size_t __n) __THROW __attribute_pure__ __nonnull((1, 2));
...
extern void *memchr(const void *__s, int __c,
                    size_t __n) __THROW __attribute_pure__ __nonnull((1));

# 138 "/usr/include/string.h" 3 4

/* Copy SRC to DEST.  */
extern char *strcpy(char *__restrict __dest,
                    const char *__restrict __src) __THROW __nonnull((1, 2));
...
extern int strcoll_l(const char *__s1, const char *__s2,
                     locale_t __l) __THROW __attribute_pure__
    __nonnull((1, 2, 3));
/* Put a transformation of SRC into no more than N bytes of DEST,
...
extern char *strndup(const char *__string,
                     size_t __n) __THROW __attribute_malloc__ __nonnull((1));
...
extern size_t strcspn(const char *__s,
                      const char *__reject) __THROW __attribute_pure__
    __nonnull((1, 2));
/* Return the length of the initial segment of S which
   consists entirely of characters in ACCEPT.  */
extern size_t strspn(const char *__s,
                     const char *__accept) __THROW __attribute_pure__
    __nonnull((1, 2));
...
extern char *strstr(const char *__haystack,
                    const char *__needle) __THROW __attribute_pure__
    __nonnull((1, 2));
...
extern char *__strtok_r(char *__restrict __s, const char *__restrict __delim,
                        char **__restrict __save_ptr) __THROW __nonnull((2, 3));
...
extern size_t strnlen(const char *__string,
                      size_t __maxlen) __THROW __attribute_pure__
    __nonnull((1));
...
extern int bcmp(const void *__s1, const void *__s2,
                size_t __n) __THROW __attribute_pure__ __nonnull((1, 2));
...
extern char *index(const char *__s, int __c) __THROW __attribute_pure__
    __nonnull((1));

/* Find the last occurrence of C in S (same as strrchr).  */
# 96 "/usr/include/strings.h" 3 4
extern char *rindex(const char *__s, int __c) __THROW __attribute_pure__
    __nonnull((1));
...
extern int strcasecmp_l(const char *__s1, const char *__s2,
                        locale_t __loc) __THROW __attribute_pure__
    __nonnull((1, 2, 3));
...
extern char *strsep(char **__restrict __stringp,
                    const char *__restrict __delim) __THROW __nonnull((1, 2));
