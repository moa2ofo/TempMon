...
int main(void)
{
  ...
  run_test(test_TempMon_Run_SequentialTransitions_NORMAL_OVER_NORMAL, "test_TempMon_Run_SequentialTransitions_NORMAL_OVER_NORMAL", 262);
  run_test(test_TempMon_Run_SequentialTransitions_NORMAL_UNDER_NORMAL, "test_TempMon_Run_SequentialTransitions_NORMAL_UNDER_NORMAL", 281);
  run_test(test_TempMon_Run_MultipleCyclesNormalOver, "test_TempMon_Run_MultipleCyclesNormalOver", 300);
  run_test(test_TempMon_Run_CustomThresholdAndHysteresis, "test_TempMon_Run_CustomThresholdAndHysteresis", 317);
  run_test(test_TempMon_Run_ExtremeTemperatureValues, "test_TempMon_Run_ExtremeTemperatureValues", 341);
