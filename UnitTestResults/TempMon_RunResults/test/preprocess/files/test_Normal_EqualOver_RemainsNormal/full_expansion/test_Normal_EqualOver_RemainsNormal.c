# 0 "utExecutionAndResults/utUnderTest/test/test_Normal_EqualOver_RemainsNormal.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_Normal_EqualOver_RemainsNormal.c"
...
# 2 "utExecutionAndResults/utUnderTest/test/test_Normal_EqualOver_RemainsNormal.c" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_Normal_EqualOver_RemainsNormal.c" 2
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_Normal_EqualOver_RemainsNormal/mock_TempMon_priv.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_Normal_EqualOver_RemainsNormal/mock_TempMon_priv.h" 2
# 1 "utExecutionAndResults/utUnderTest/src/TempMon_priv.h" 1
# 7 "utExecutionAndResults/utUnderTest/build/test/mocks/test_Normal_EqualOver_RemainsNormal/mock_TempMon_priv.h" 2
...
# 4 "utExecutionAndResults/utUnderTest/test/test_Normal_EqualOver_RemainsNormal.c" 2
...
# 6 "utExecutionAndResults/utUnderTest/test/test_Normal_EqualOver_RemainsNormal.c" 2


# 7 "utExecutionAndResults/utUnderTest/test/test_Normal_EqualOver_RemainsNormal.c"
```c
...
static 
# 14 "utExecutionAndResults/utUnderTest/test/test_Normal_EqualOver_RemainsNormal.c" 3 4
      _Bool 
# 14 "utExecutionAndResults/utUnderTest/test/test_Normal_EqualOver_RemainsNormal.c"
           IsUnderEnter_b_Callback(int32_t temp_mC, int cmock_num_calls) {
  return (temp_mC < g_UnderThreshold_mC_s32);
}

static 
# 18 "utExecutionAndResults/utUnderTest/test/test_Normal_EqualOver_RemainsNormal.c" 3 4
      _Bool 
# 18 "utExecutionAndResults/utUnderTest/test/test_Normal_EqualOver_RemainsNormal.c"
           IsUnderExit_b_Callback(int32_t temp_mC, int cmock_num_calls) {
  return (temp_mC > (g_UnderThreshold_mC_s32 + g_Hyst_mC_s32));
}

static 
# 22 "utExecutionAndResults/utUnderTest/test/test_Normal_EqualOver_RemainsNormal.c" 3 4
      _Bool 
# 22 "utExecutionAndResults/utUnderTest/test/test_Normal_EqualOver_RemainsNormal.c"
           IsOverEnter_b_Callback(int32_t temp_mC, int cmock_num_calls) {
  return (temp_mC > g_OverThreshold_mC_s32);
}

static 
# 26 "utExecutionAndResults/utUnderTest/test/test_Normal_EqualOver_RemainsNormal.c" 3 4
      _Bool 
# 26 "utExecutionAndResults/utUnderTest/test/test_Normal_EqualOver_RemainsNormal.c"
