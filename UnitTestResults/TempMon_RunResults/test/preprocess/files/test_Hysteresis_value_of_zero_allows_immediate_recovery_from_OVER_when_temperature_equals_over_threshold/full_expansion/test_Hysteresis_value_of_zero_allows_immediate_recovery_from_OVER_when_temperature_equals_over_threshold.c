# 0 "utExecutionAndResults/utUnderTest/test/test_Hysteresis_value_of_zero_allows_immediate_recovery_from_OVER_when_temperature_equals_over_threshold.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_Hysteresis_value_of_zero_allows_immediate_recovery_from_OVER_when_temperature_equals_over_threshold.c"
...
# 2 "utExecutionAndResults/utUnderTest/test/test_Hysteresis_value_of_zero_allows_immediate_recovery_from_OVER_when_temperature_equals_over_threshold.c" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_Hysteresis_value_of_zero_allows_immediate_recovery_from_OVER_when_temperature_equals_over_threshold.c" 2
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_Hysteresis_value_of_zero_allows_immediate_recovery_from_OVER_when_temperature_equals_over_threshold/mock_TempMon_priv.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_Hysteresis_value_of_zero_allows_immediate_recovery_from_OVER_when_temperature_equals_over_threshold/mock_TempMon_priv.h" 2
# 1 "utExecutionAndResults/utUnderTest/src/TempMon_priv.h" 1
# 7 "utExecutionAndResults/utUnderTest/build/test/mocks/test_Hysteresis_value_of_zero_allows_immediate_recovery_from_OVER_when_temperature_equals_over_threshold/mock_TempMon_priv.h" 2
...
# 4 "utExecutionAndResults/utUnderTest/test/test_Hysteresis_value_of_zero_allows_immediate_recovery_from_OVER_when_temperature_equals_over_threshold.c" 2
...
# 6 "utExecutionAndResults/utUnderTest/test/test_Hysteresis_value_of_zero_allows_immediate_recovery_from_OVER_when_temperature_equals_over_threshold.c" 2
...
# 13 "utExecutionAndResults/utUnderTest/test/test_Hysteresis_value_of_zero_allows_immediate_recovery_from_OVER_when_temperature_equals_over_threshold.c"
void setUp(void) {
...
# 31 "utExecutionAndResults/utUnderTest/test/test_Hysteresis_value_of_zero_allows_immediate_recovery_from_OVER_when_temperature_equals_over_threshold.c" 3 4
 ((void *)0)
# 31 "utExecutionAndResults/utUnderTest/test/test_Hysteresis_value_of_zero_allows_immediate_recovery_from_OVER_when_temperature_equals_over_threshold.c"
