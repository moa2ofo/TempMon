...
# 80 "utExecutionAndResults/utUnderTest/src/TempMon.h"
extern int32_t g_UnderThreshold_mC_s32;
# 94 "utExecutionAndResults/utUnderTest/src/TempMon.h"
...
# 245 "utExecutionAndResults/utUnderTest/src/TempMon.h"
TempMon_sts_e TempMon_GetSts(void);
# 283 "utExecutionAndResults/utUnderTest/src/TempMon.h"

# 283 "utExecutionAndResults/utUnderTest/src/TempMon.h" 3 4
_Bool 
# 283 "utExecutionAndResults/utUnderTest/src/TempMon.h"
    TempMon_IsUnderAlv_b(void);
# 321 "utExecutionAndResults/utUnderTest/src/TempMon.h"

# 321 "utExecutionAndResults/utUnderTest/src/TempMon.h" 3 4
_Bool 
# 321 "utExecutionAndResults/utUnderTest/src/TempMon.h"
...
void TempMon_Init_CMockExpectAnyArgs(UNITY_UINT cmock_line);


void TempMon_Init_CMockExpect(UNITY_UINT cmock_line, int32_t temp_mC);
...
void TempMon_Init_CMockIgnoreArg_temp_mC(UNITY_UINT cmock_line);
...
void TempMon_Run_CMockExpectAnyArgs(UNITY_UINT cmock_line);


void TempMon_Run_CMockExpect(UNITY_UINT cmock_line, int32_t temp_mC);
...
void TempMon_Run_CMockIgnoreArg_temp_mC(UNITY_UINT cmock_line);


void TempMon_GetSts_CMockIgnoreAndReturn(UNITY_UINT cmock_line, TempMon_sts_e cmock_to_return);

void TempMon_GetSts_CMockStopIgnore(void);


void TempMon_GetSts_CMockExpectAndReturn(UNITY_UINT cmock_line, TempMon_sts_e cmock_to_return);
...
void TempMon_IsUnderAlv_b_CMockIgnoreAndReturn(UNITY_UINT cmock_line, _Bool cmock_to_return);

void TempMon_IsUnderAlv_b_CMockStopIgnore(void);


void TempMon_IsUnderAlv_b_CMockExpectAndReturn(UNITY_UINT cmock_line, _Bool cmock_to_return);
...
void TempMon_IsOverAlv_b_CMockIgnoreAndReturn(UNITY_UINT cmock_line, _Bool cmock_to_return);

void TempMon_IsOverAlv_b_CMockStopIgnore(void);


void TempMon_IsOverAlv_b_CMockExpectAndReturn(UNITY_UINT cmock_line, _Bool cmock_to_return);
...
# 108 "utExecutionAndResults/utUnderTest/build/test/mocks/test_IsOverExit_b_1/mock_TempMon.h"
