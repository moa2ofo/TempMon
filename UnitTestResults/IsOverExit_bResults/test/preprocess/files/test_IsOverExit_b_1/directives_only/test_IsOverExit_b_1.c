# 0 "utExecutionAndResults/utUnderTest/test/test_IsOverExit_b_1.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_IsOverExit_b_1.c"
# 1 "utExecutionAndResults/utUnderTest/src/IsOverExit_b.h" 1

#define TEST_ISOVEREXIT_B_H 
...
# 2 "utExecutionAndResults/utUnderTest/test/test_IsOverExit_b_1.c" 2
...
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_IsOverExit_b_1/mock_TempMon.h" 1
...
# 7 "utExecutionAndResults/utUnderTest/build/test/mocks/test_IsOverExit_b_1/mock_TempMon.h" 2
...
#define TempMon_IsUnderAlv_b_Ignore() TEST_FAIL_MESSAGE("TempMon_IsUnderAlv_b requires _IgnoreAndReturn");
#define TempMon_IsUnderAlv_b_IgnoreAndReturn(cmock_retval) TempMon_IsUnderAlv_b_CMockIgnoreAndReturn(__LINE__, cmock_retval)
void TempMon_IsUnderAlv_b_CMockIgnoreAndReturn(UNITY_LINE_TYPE cmock_line, _Bool cmock_to_return);
#define TempMon_IsUnderAlv_b_StopIgnore() TempMon_IsUnderAlv_b_CMockStopIgnore()
void TempMon_IsUnderAlv_b_CMockStopIgnore(void);
#define TempMon_IsUnderAlv_b_Expect() TEST_FAIL_MESSAGE("TempMon_IsUnderAlv_b requires _ExpectAndReturn");
#define TempMon_IsUnderAlv_b_ExpectAndReturn(cmock_retval) TempMon_IsUnderAlv_b_CMockExpectAndReturn(__LINE__, cmock_retval)
void TempMon_IsUnderAlv_b_CMockExpectAndReturn(UNITY_LINE_TYPE cmock_line, _Bool cmock_to_return);
typedef _Bool (* CMOCK_TempMon_IsUnderAlv_b_CALLBACK)(int cmock_num_calls);
...
#define TempMon_IsUnderAlv_b_StubWithCallback TempMon_IsUnderAlv_b_Stub
...
# 5 "utExecutionAndResults/utUnderTest/test/test_IsOverExit_b_1.c" 2
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_IsOverExit_b_1/mock_TempMon_priv.h" 1
/* AUTOGENERATED FILE. DO NOT EDIT. */
...
# 7 "utExecutionAndResults/utUnderTest/build/test/mocks/test_IsOverExit_b_1/mock_TempMon_priv.h" 2
...
#define IsUnderEnter_b_Ignore() TEST_FAIL_MESSAGE("IsUnderEnter_b requires _IgnoreAndReturn");
#define IsUnderEnter_b_IgnoreAndReturn(cmock_retval) IsUnderEnter_b_CMockIgnoreAndReturn(__LINE__, cmock_retval)
...
typedef _Bool (* CMOCK_IsUnderExit_b_CALLBACK)(int32_t temp_mC, int cmock_num_calls);
...
typedef _Bool (* CMOCK_IsOverEnter_b_CALLBACK)(int32_t temp_mC, int cmock_num_calls);
...
# 6 "utExecutionAndResults/utUnderTest/test/test_IsOverExit_b_1.c" 2

void setUp(void) {}

void tearDown(void) {}

void test_IsOverExit_b(void)
{
